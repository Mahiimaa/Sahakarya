          ...
          <div className="flex flex-col left-0 self-start justify-center items-center pl-8 gap-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex  items-center gap-6 p-4">
                  ...
                  <p className='font-poppins font-regular text-grey'>Dashboard</p>
                  </div>
                </NavLink>
                ...
                <div className="flex items-center gap-6 p-4">
                  ...
                  <p className='font-poppins font-regular text-grey'>Users</p>
                  </div>
                </NavLink>
                ...
                <div className="flex items-center gap-6 p-4">
                  ...
                  <p className='font-poppins font-regular text-grey'> Services</p>
                  </div>
                </NavLink>
                ...
                <div className="flex justify-center items-center gap-6 p-4 ">
                  ...
                  <p className='font-poppins font-regular text-grey'>Transactions</p>
                  </div>
                </NavLink>
                ...
                <div className='flex items-center gap-6 p-4'>
                  ...
                  <p className='font-poppins font-regular text-grey'>Category</p>
                  </div>
                </NavLink>
            </div>
            </div>
                ...
                <div className='flex items-center gap-6 p-4'>
                  ...
                  <p className='font-poppins font-regular text-grey'> Settings</p>
                  </div>
                </NavLink>
        </div>
        </div>
